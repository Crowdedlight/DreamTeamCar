; Dette program venter på at få besked på at køre og bremser når den når en hvid linje
; Dette bruges til at bestemme acceleration og deacceleration, evt også topfart
...
Timer_init0:			
	...
	ldi     R16, 0b00000100 ; 256 prescale og normale mode
    out	TCCR0, R16
...
Timer_init1:
 ...
 Hardware_int_init:
    ...
    out MCUCR,R16           ; Sætter INT0 til at trigge på falling
...
Read_Acc:
	...
	in	R18, ADCL	;ADC læses, ADCL bruges ikke.
	in	R18, ADCH	;ADC læses, ADCH bruges.
