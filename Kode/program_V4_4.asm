...
;Det at holde farten er også inkluderet i dette program
.include "m32def.inc"
...
Sving:
		...
		cpi	    R26, 30				;Sammenligner reelle hastighed med teoretisk		
		brge 	Increase				;Tjekker wheelspeed mod teoretisk maks
		dec 	R17	    				;Øger hastighedsregister
		out 	OCR2, R17				;Outer ændret hastighed til OCR2. 
		ret         					;Hopper tilbage til check.
		
		Increase:
		inc	    R17			    		;Sænker hastighedsregister
		out	    OCR2, R17   
		ret				            	;Hopper tilbage til check
ret
