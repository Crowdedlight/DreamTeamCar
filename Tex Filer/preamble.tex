...
\usepackage[top=3cm, bottom=3cm, left=3.5cm, right=3.0cm]{geometry}
...
\newcommand{\forfattere}{Sebastian Bailey Hass, Morten Pedersen \& Frederik Mazur Andersen}
\newcommand{\titel}{Undersøgelse af Dynamiske Systemer}
\newcommand{\korttitel}{Dynamiske Systemer}
\newcommand{\afldato}{21. Oktober 2014}
\newcommand{\fag}{Fysik}
\newcommand{\klasse}{GSR-1}
